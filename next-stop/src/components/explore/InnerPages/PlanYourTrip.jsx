...
import { FaLightbulb, FaUserTie, FaPhoneAlt, FaTags } from "react-icons/fa";
    ...
    <div className="bg-[#fffaf0]">
      <div className="p-4 md:p-10 space-y-16">
        ...
        <div className="space-y-6 overflow-hidden">
          <h2 className="text-3xl font-bold text-[#800000] text-center mb-12 mt-12">
            Accommodation Deals
          </h2>
                ...
                >
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <button
                      onClick={() =>
                        alert(
                          `🔥 ${item.title} at ${item.name}!\nCheck out this special offer and plan your stay soon!`
                        )
                      }
          ...
          <div className="grid gap-6">
            {planningTips.travelAgents.map((agent, index) => (
              ...
              >
                ...
                <div className="flex-1 pl-5 space-y-2">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    ...
                    <button
                      onClick={() =>
                        alert(
                          `ℹ️ Learn more about ${agent.name} at ${agent.agency}!`
                        )
                      }
                ...
                <button
                  onClick={() =>
                    alert(`📞 Contact ${agent.name} at +91-9876543210`)
                  }
        ...
        <div className="space-y-8">
          ...
          <motion.div
            onClick={() =>
              alert(
                `💡 Tip: ${planningTips.tip.description}\nPlan your trip carefully for an amazing experience!`
              )
            }
            whileHover={{ scale: 1.02 }}
            className="rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-[#fff] to-[#f9f9f9] border border-gray-200 block max-w-4xl mx-auto cursor-pointer"
          >
