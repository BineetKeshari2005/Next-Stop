...
const categories = [
  {
    ...
    link: "/explore?category=Nature's Escape",
  ...
  },
  {
    ...
    link: "/explore?category=Historic Places",
  ...
  },
  {
    ...
    link: "/explore?category=Arts & Culture",
  ...
  },
  {
    ...
    link: "/explore?category=Adventure Trips",
...
export default function ExploreCategories() {
  return (
    <section className="py-20 bg-gradient-to-br from-[#fffaf5] to-[#fff0e6] text-center">
      <h2 className="text-4xl font-extrabold text-[#800000] mb-12 drop-shadow-sm">
        Explore Categories
      </h2>
      ...
      <Link
        key={index}
        to={`/explore?category=${encodeURIComponent(cat.key)}`}
        state={{ fromCategoriesPage: true }} // <-- add this
