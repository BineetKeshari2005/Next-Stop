...
import { FaUserCircle,FaUserAlt ,FaLock,FaSearch } from 'react-icons/fa';
       ...
       {isOpen && (
        ...
        <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50 ">
          <div className=" backdrop-blur-3xl p-8 border border-gray-300 rounded-xl shadow-2xl w-96 space-y-6 animate-fade-in text-gray-900 ">
            ...
            <div className='absolute top-0 right-0 bg-[#162938] w-11 h-11 text-lg text-white flex justify-center align-center cursor-pointer rounded-bl-[20px] rounded-tr-xl '>
            ...
            <div className=" pt-2 text-sm text-center">
              <span className='text-white'>{isSignup ? "" :  'Dont have an account ?       '}</span>
              <button
